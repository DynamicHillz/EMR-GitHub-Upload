...
router.post('/patient/:patientId/pregnancies', CAN_MANAGE, ancController.createPregnancy);
router.put('/pregnancies/:pregnancyId', CAN_MANAGE, ancController.updatePregnancyStatus);

// ANC Visits
router.get('/pregnancies/:pregnancyId/visits', CAN_VIEW, ancController.getVisitsByPregnancy);
router.post('/pregnancies/:pregnancyId/visits', CAN_MANAGE, ancController.createVisit);
